    ...
    $.ajax({
      ...
      success:function(response){
        if(response == 1){
          ...
          var cid = $("#cryptid").val();
          var url = '{{ route("show_technical", ":id") }}';
      ...
      <div class="col-md-7">
              ...
              <div class="col-lg-9">
                <input type="hidden" id="staff_id" value="{{ (!empty($tasks->user_id)) ? $tasks->user_id : ''  }}">
                  ...
                  @if(isset($tasks->user_id))
                    @if($tasks->user_id != Auth::user()->id && $complaint->status_id < 3)
        ...
        <div class="row">
          <div class="col-md-12 text-left" style="margin-bottom: 20px">
            ...
            <input type="hidden" id="cryptid" name="cryptid" value="{{ Crypt::encrypt($complaint->id) }}">
