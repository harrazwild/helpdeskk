...
<div class="ui-content-body">
  <div class="ui-container">
    ...
    <div class="row">
      ...
      <div class="col-md-7">
        <form class="form-horizontal" method="post" action="{{ route('update_complaint_verify') }}">
        @csrf
        <div class="panel {{ $panel }}">
          ...
          <div class="panel-body">
            ...
            <div class="form-group">
              ...
              <div class="col-lg-5">
                <select class="form-control" name="status" id="status">
                  ...
                  <option value="8">Tutup Aduan</option>
            ...
            <div class="form-group" id="officer">
              ...
              <div class="col-lg-9">
                <p class="form-control-static" style="white-space: normal;">{{ (!empty($complaint->officer_id)) ? App\Helper\Utilities::getStaffName($complaint->officer_id) : "-"  }}</p>
              </div>
            </div>
