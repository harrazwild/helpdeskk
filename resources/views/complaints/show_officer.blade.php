...
$(document).ready(function(){
  ...
  @if((isset($tasks->user_id) && $tasks->user_id != '') || $complaint->status_id == 1 || $complaint->status_id == 4)
    $('#staff').show();
  @else
    $('#staff').hide();
  @endif
...
<div class="ui-content-body">
  <div class="ui-container">
    ...
    <div class="row">
      ...
      <div class="col-md-7">
        <form class="form-horizontal" method="post" action="{{ route('officer_update_complaint') }}">
        @csrf
          ...
          <div class="panel-body">
            ...
            <div class="form-group" id="staff">
              ...
              <div class="col-lg-9">
                ...
                <input type="hidden" name="status_id" value="{{ (!empty($complaint->status_id)) ? $complaint->status_id : ''  }}">
                @if($complaint->status_id < 4) <!-- jika pentadbir -->
            ...
            @if($complaint->status_id == 3 || isset($complaint->officer_id))
            <div class="form-group">
            ...
            @endif
            @if($complaint->status_id == 3 && $complaint->officer_id == Auth::user()->id)
            <div class="form-group">
              <label class=" col-sm-3 control-label">Status Tindakan</label>
              <div class="col-lg-5">
                <select class="form-control" name="status" id="status">
                  <option value="">Sila Pilih</option>
                  <option value="2">Serah Kepada Pegawai Teknikal</option>
