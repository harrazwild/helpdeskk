...
<div class="ui-content-body">  
    <div class="ui-container">
        ...
        <div class="row">
            <div class="col-sm-12">
                <form class="form-horizontal" method="post" action="{{ route('upd_user', Crypt::encrypt($user->id)) }}">
                @csrf
                @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <select name="role_id" id="role_id" class="form-control @error('role_id') is-invalid @enderror">
                                            ...
                                            <option value="{{ $row->id }}" {{ $user->role_id == $row->id ? 'selected' : '' }} >{{ $row->role_desc }}</option>
                                            @endforeach
                                        </select>
                                        @error('role_id')
