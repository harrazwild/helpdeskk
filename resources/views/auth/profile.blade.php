...
<div class="ui-content-body">  
    <div class="ui-container">
        ...
        <div class="row">
            <div class="col-sm-12">
                <form class="form-horizontal" method="post" action="{{ route('update_profile', Crypt::encrypt($user->id)) }}">
                @csrf
                @method('PUT')
                        ...
                        <div class="form-group" id="sectionDIV">
                            ...
                            <div class="col-lg-4">
                                <select name="section_id" id="section_id" class="form-control section @error('section_id') is-invalid @enderror">
                                    ...
                                    <option value="{{ $row->id }}" {{ $user->section_id == $row->id ? 'selected' : '' }} >{{ $row->section_desc }}</option>
                                    @endforeach
                                </select>
                                @error('section_id')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <select name="block" id="block" class="form-control @error('block') is-invalid @enderror">
                                            <option value="">Sila Pilih</option>
                                            <option value="F2" {{ $user->block == 'F2' ? 'selected' : '' }} >Blok F2</option>
                                            <option value="F3" {{ $user->block == 'F3' ? 'selected' : '' }} >Blok F3</option>
                                        </select>
                                        @error('block')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <select name="level" id="level" class="form-control @error('level') is-invalid @enderror">
                                            <option value="">Sila Pilih</option>
                                            <option value="L1" {{ $user->level == 'L1' ? 'selected' : '' }} >Aras 1</option>
                                            <option value="L2" {{ $user->level == 'L2' ? 'selected' : '' }} >Aras 2</option>
                                            <option value="L3" {{ $user->level == 'L3' ? 'selected' : '' }} >Aras 3</option>
                                            <option value="L4" {{ $user->level == 'L4' ? 'selected' : '' }} >Aras 4</option>
                                            <option value="L5" {{ $user->level == 'L5' ? 'selected' : '' }} >Aras 5</option>
                                            <option value="L6" {{ $user->level == 'L6' ? 'selected' : '' }} >Aras 6</option>
                                            <option value="L7" {{ $user->level == 'L7' ? 'selected' : '' }} >Aras 7</option>
                                            <option value="L8" {{ $user->level == 'L8' ? 'selected' : '' }} >Aras 8</option>
                                            <option value="L9" {{ $user->level == 'L9' ? 'selected' : '' }} >Aras 9</option>
                                        </select>
                                        @error('level')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <select name="zone" id="zone" class="form-control @error('zone') is-invalid @enderror">
                                            <option value="">Sila Pilih</option>
                                            <option value="A" {{ $user->zone == 'A' ? 'selected' : '' }} >Zon A</option>
                                            <option value="B" {{ $user->zone == 'B' ? 'selected' : '' }} >Zon B</option>
                                        </select>
                                        @error('zone')
        ...
        <div class="row">
            <div class="col-sm-12">
                <form class="form-horizontal" method="post" action="{{ route('update_password', Crypt::encrypt($user->id)) }}">
                @csrf
                @method('PUT')
                <section class="panel panel-default">
